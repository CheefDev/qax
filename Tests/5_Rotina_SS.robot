...
Cadastro S.S.
    ...
    ${newSsButton}          Set Variable     android=UiSelector().className("android.widget.Button")
    ${campoSolicitacao}     Set Variable     android=UiSelector().className("android.widget.EditText").instance(0)
    ${btnDataParou}         Set Variable     android=UiSelector().className("android.widget.ImageView").instance(8)
    ${btnPrazo}             Set Variable     android=UiSelector().className("android.widget.ImageView").instance(10)
    ${campoUrgencia}        Set Variable     android=UiSelector().className("android.widget.EditText").instance(5)
    ${searchAplicacao}      Set Variable     android=new UiSelector().className("android.widget.ImageView").instance(12)
    ${searchCentroCusto}    Set Variable     android=new UiSelector().className("android.widget.ImageView").instance(15)
    ...
    ${searchCliente}        Set Variable    android=UiSelector().className("android.widget.ImageView").instance(16)
    ${searchSetor}          Set Variable    android=UiSelector().className("android.widget.ImageView").instance(19)
    ${searchTipoManut}      Set Variable    android=UiSelector().className("android.widget.ImageView").instance(22)
    ${searchLocalizacao}    Set Variable    android=UiSelector().className("android.widget.ImageView").instance(25)
